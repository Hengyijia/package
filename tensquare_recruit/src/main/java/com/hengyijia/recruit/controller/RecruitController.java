package com.hengyijia.recruit.controller;
import java.util.List;
import java.util.Map;

import com.hengyijia.recruit.pojo.Recruit;
import com.hengyijia.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result findByRecommend(){
		List<Recruit> list = recruitService.findByRecommend();
		return new Result(true,StatusCode.OK,"查询成功",list);
	}

	@GetMapping("/search/newlist")
	public Result findByNewList(){
		List<Recruit> list = recruitService.findByNewList();
		return new Result(true,StatusCode.OK,"查询成功",list);
	}
	/**
	 * 查询全部数据
